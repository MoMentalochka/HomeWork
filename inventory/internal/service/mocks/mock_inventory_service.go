...
import (
	...
	model "github.com/MoMentalochka/HomeWork/inventory/internal/model"
...
func (_m *InventoryService) GetPart(_a0 context.Context, uuid string) (model.Part, error) {
...
//   - _a0 context.Context
//   - uuid string
func (_e *InventoryService_Expecter) GetPart(_a0 interface{}, uuid interface{}) *InventoryService_GetPart_Call {
	return &InventoryService_GetPart_Call{Call: _e.mock.On("GetPart", _a0, uuid)}
}

func (_c *InventoryService_GetPart_Call) Run(run func(_a0 context.Context, uuid string)) *InventoryService_GetPart_Call {
...
func (_m *InventoryService) ListParts(_a0 context.Context, filters *model.PartsFilter) ([]*model.Part, error) {
...
func (_e *InventoryService_Expecter) ListParts(_a0 interface{}, filters interface{}) *InventoryService_ListParts_Call {
	return &InventoryService_ListParts_Call{Call: _e.mock.On("ListParts", _a0, filters)}
}

func (_c *InventoryService_ListParts_Call) Run(run func(_a0 context.Context, filters *model.PartsFilter)) *InventoryService_ListParts_Call {
	_c.Call.Run(func(args mock.Arguments) {
