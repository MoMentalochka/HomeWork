...
import (
	...
	iam_v1 "github.com/MoMentalochka/HomeWork/shared/pkg/proto/iam/v1"
...
func (a *App) initGRPCServer(ctx context.Context) error {
	...
	iam_v1.RegisterIamServiceServer(a.grpcServer, a.diContainer.IamV1API(ctx))
	return nil
}

func (a *App) runGRPCServer(ctx context.Context) error {
	logger.Info(ctx, fmt.Sprintf("🚀 gRPC Iam Service server listening on %s", config.AppConfig().IamGRPC.Address()))
