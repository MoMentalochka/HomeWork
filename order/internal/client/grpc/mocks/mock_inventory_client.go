...
func (_m *InventoryClient) ListParts(ctx context.Context, filters model.PartsFilter) ([]model.Part, error) {
...
func (_e *InventoryClient_Expecter) ListParts(ctx interface{}, filters interface{}) *InventoryClient_ListParts_Call {
	return &InventoryClient_ListParts_Call{Call: _e.mock.On("ListParts", ctx, filters)}
}

func (_c *InventoryClient_ListParts_Call) Run(run func(ctx context.Context, filters model.PartsFilter)) *InventoryClient_ListParts_Call {
